...
import { startExpenseChart } from "../../../reduxStore/actions/expensesAction"
import "../../../asstes/css/budgetChart.css"

const BudgetCalulation = (props) => {
    ...
    const budgetRemains = Object.keys(chartDatas).length>0 && chartDatas.totlaBudget - chartDatas.totleExpense
    ...
    const data = {
        labels: [`Total Expenses ${chartDatas.totleExpense}`, `Total Budget Remains ${budgetRemains}`],
        datasets: [
            {
                label: '',
                data: [chartDatas.totleExpense, totalBudgetRemains ],
                backgroundColor: [
                    'rgba(255, 99, 132, 1)',
                    'rgba(255, 206, 86, 0.8)',
                ],
    ...
    return (
        <div className='chart-container'>
            ...
            {
                chartDatas.totalPercentage ? (
                    <div className="chart-calulation">
                        <Doughnut data={data} />
                        <span>Total Percentage of Expenses Done : {chartDatas.totalPercentage}%</span>
                    </div>
                ) : (
...
export default BudgetCalulation