...
import { startBudgetUpdate } from "../../../reduxStore/actions/budgetsAction"
import "../../../asstes/css/budget.css"


const BudgetForm = (props)=>{
    const {handleIsBudgetToggle,amount:budgetAmount} = props
        ...
        <div>
            <Form onSubmit={handleFormSubmit}>
                ...
                <div className="budget-form-btns">
                    ...
                    <Button variant="secondary" onClick={handleIsBudgetToggle}>Cancle</Button>
                </div>
            </Form>
        </div>
    )
